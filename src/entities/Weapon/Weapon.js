...
export default class Weapon extends Component {
    ...
    SetAnimations() {
        ...
        this.SetAnimation('idle', this.model.animations[1]);
        this.SetAnimation('reload', this.model.animations[2]);
        this.SetAnimation('shoot', this.model.animations[0]);
    }
